...
public class HealthCheck {
    ...
    @Autowired
    public HealthCheck(DiscoveryClient client, Registration registration) {//没错，ide没检测出来
        this.client = client;
     ...
     * */
    //通用模块，对于统一异常的处理，接口验证一下统一异常 处理是否好用（couponException)
    ...
    public List<Map<String, Object>> info() {
        ...
        List<ServiceInstance> instances =
                client.getInstances(registration.getServiceId()); //实例可能多实例部署，所以返回list
